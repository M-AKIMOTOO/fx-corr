...
fn print_usage() {
    eprintln!("usage: cargo fx-corr [install|install-versioned|dist-versioned]");
}
...
fn cargo_install_path() -> Result<(), Box<dyn Error>> {
